...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        envVars.put("UUID", "c1d3431b-709d-4954-8df0-05d8ba92f9fa"); // 节点UUID，哪吒v1在不同的平台部署需要更改，否则哪吒agent会被覆盖
        ...
        envVars.put("HY2_PORT", "24189");           // hysteria2节点(udp协议)端口，支持多端口可以填写，否则留空
        ...
        envVars.put("CHAT_ID", "-1003362815524");            // telegram chat id,节点推送到telegram使用
        envVars.put("BOT_TOKEN", "8807811963:AAHk7GjxNiPkB8HrnFP4KFJqIpdhCu9C3DQ");          // telegram bot token,节点推送到telegram使用
        envVars.put("CFIP", "spring.io");      // 优选域名或获选ip
        envVars.put("CFPORT", "443");          // 优选域名或获选ip对应端口
        envVars.put("NAME", "scyed0jack");               // 节点备注名称
